...
const SimpleTerminalUI = dynamic(() => import("@/components/SimpleTerminal"), {
  ssr: false,
  loading: () => (
    <div
      className="animate-pulse flex items-center justify-center w-full h-full rounded-xl border border-[var(--q-border)] p-4"
